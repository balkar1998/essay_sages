   ...
   <img class="bg-image">
     ...
     <p class="w-50 font fw-bold text-center">{{$topline}}</p>         
         ...
         <div class="mt-5 mb-5 row d-flex w-50 justify-content-between">
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/convenient.png') }}" alt="Coursework Writing Service"/><span class="font pad"> Hassle-Free Order Process</span></div>
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/24-hours.png') }}" alt="Coursework Services"/><span class="font pad">Qualified Writing Experts</span></div>
         ...
         <div class="mt-5 mb-5 row d-flex w-50 justify-content-between">
            ...
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/shield.png') }}" alt="Custom Coursework Writing"/><span class="font pad">Full Privacy</span></div>
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/original.png') }}" alt="Coursework Writing Service"/><span class="font pad">Plagiarism-Free Content</span> </div>
         </div>
      </div>
   </div>
</div>

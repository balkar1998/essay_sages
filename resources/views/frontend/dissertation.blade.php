...
<div class="col-md-12 my-3">
   <img class="bg-image">
    ...
    <p class="font fw-bold" style="color: #ffc107;">{{$bottomline}}</p>
         ...
         <div class="mt-5 mb-5 row d-flex w-50 justify-content-between">
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/certificate.png') }}" alt="Dissertation Writing"/><span class="font pad">24*7 Service Available</span></div>
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/shield.png') }}" alt="Dissertation Writing Service"/><span class="font pad">Full Privacy</span></div>
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/original.png') }}" alt="Custom Dissertation Services"/><span class="font pad">Plagiarism-Free Content</span> </div>
         </div>
      </div>
   </div>
</div>
